...
#ifndef PWM_TESTSUITE_H
#define PWM_TESTSUITE_H
 ...
 */
class ProxyTestling : public Pwm {
   private:
    ProxyTestling();
   ...
   public:
    ...
    // Here, you need to add all methods which are protected in Pwm and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class PwmTest : public CxxTest::TestSuite {
 private:
  ProxyTestling *dt;
 ...
 private:
   ...
   */
  PwmTest &operator=(const PwmTest & /*obj*/);
};
